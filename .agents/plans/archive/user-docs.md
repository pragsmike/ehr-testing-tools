# Archive: User Documentation (DOC waves) — spent content

All rows below landed and are Done; moved here from the live plan
(NAV-1, 2026-07-27) per the plans-archive convention. Kept verbatim
for provenance, not read as live work. The live plan
(`.agents/plans/user-docs.md`) keeps only its framing, the Deferred
