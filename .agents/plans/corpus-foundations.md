...
| P3 | Artifact registry, result/invocation/locator/canonical schemas, `corpus.generate`, `ehr` CLI, EXP-A4 executed (manifest v1) | This session (2026-07-24) | `.agents/prompts/2026-07-24-p3-generation-exp-a4.md` (archived at session end) |
