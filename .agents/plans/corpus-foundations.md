...
| R | Judge/gate factorization: vocabulary refactor per `docs/palgebra-design.md` and `.agents/plans/judge-gate-refactor.md`; no new capability | In progress (2026-07-25) | `.agents/prompts/archive/2026-07-25-r1-judge-gate-renames.md` |
