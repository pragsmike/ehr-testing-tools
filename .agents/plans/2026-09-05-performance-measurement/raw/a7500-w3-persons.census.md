...
- `/home/mg/perf-out/a7500-w3-persons.run1.edn` -- 167184 events

Total: **167184 events**, **28 kinds**.
...
### `:bed-status-change` (n=41396)

| key | present | nil | value shape |
|---|---|---|---|
| `:bed` | 41396 (always) | - | `string` |
| `:event` | 41396 (always) | - | `keyword` |
| `:from` | 41396 (always) | - | `keyword` |
| `:last-patient-id` | 13902/41396 | - | `string` |
| `:participants` | 41396 (always) | - | `vector<map{bed-id,role,ward}>` |
| `:t` | 41396 (always) | - | `long` |
| `:to` | 41396 (always) | - | `keyword` |
| `:ward` | 41396 (always) | - | `string` |
| `:warm-up` | 41396 (always) | - | `boolean` |
...
| key | present | nil | value shape |
|---|---|---|---|
| `:attempted-step` | 149 (always) | - | `map{type}` |
| `:encounter-id` | 91/149 | - | `string` |
| `:event` | 149 (always) | - | `keyword` |
| `:participants` | 149 (always) | - | `vector<map{patient-id,role}>` |
| `:reason` | 149 (always) | - | `keyword` |
| `:t` | 149 (always) | - | `long` |
| `:warm-up` | 149 (always) | - | `boolean` |

### `:transfer` (n=7330)

| key | present | nil | value shape |
|---|---|---|---|
| `:active-mrn` | 7330 (always) | - | `string` |
| `:attending` | 7330 (always) | - | `string` |
| `:bed-ready` | 7330 (always) | - | `boolean` |
| `:encounter-id` | 7330 (always) | - | `string` |
| `:event` | 7330 (always) | - | `keyword` |
| `:forced` | 7330 (always) | - | `boolean` |
| `:from` | 7330 (always) | - | `map{bed,placement,ward}` |
| `:home-ward` | 7330 (always) | - | `string` |
| `:location` | 7330 (always) | - | `map{bed,placement,ward}` |
| `:participants` | 7330 (always) | - | `vector<map{patient-id,role}>` |
| `:placement` | 2375/7330 | - | `keyword` |
| `:t` | 7330 (always) | - | `long` |
| `:warm-up` | 7330 (always) | - | `boolean` |
...
- `/home/mg/perf-out/a7500-w3-persons.run1.edn`: :admission 8062, :appointment 7340, :appointment-cancel 592, :bed-status-change 41396, :bed-swap 2220, :cancel-admit 54, :cancel-discharge 51, :cancel-transfer 2176, :care-plan-end 3486, :care-plan-start 3567, :coverage-change 7341, :demographic-update 13477, :diagnostic-report 2446, :discharge 8001, :medication-end 4885, :medication-order 4978, :merge 891, :no-show 981, :observation 7827, :order-placed 10274, :outpatient-visit 2318, :outpatient-visit-end 2316, :procedure 5461, :registered 8521, :reschedule 770, :result-available 10274, :step-rejected 149, :transfer 7330

## Per-corpus `:t` monotonicity (a RUN-level property)

- `/home/mg/perf-out/a7500-w3-persons.run1.edn`: `(apply <= (map :t ...))` = **true**
