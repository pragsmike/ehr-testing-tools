...
| kind | count | names |
|---|---|---|
| components | 19 | `corpus`, `corpus-io`, `docs-tooling`, `judge`, `judge-fhir-official`, `judge-v2-hapi`, `judge-v2-nist`, `kernel`, `oracle`, `palgebra`, `patient-simulator`, `person-simulator`, `provenance`, `sim`, `sim-check`, `sim-emit-fhir`, `sim-emit-hl7`, `sim-engine`, `sim-model` |
| bases | 1 | `cli` |
...
| roadmap rows (all sections) | 69 |
| rulings rows | 113 |
| rulings rows superseded | 6 |
| session records | 205 |
| archived prompts | 196 |
...
|---|---|---|---|---|---|
| :corpus | 7 | 1891 | 2045 | 2045 | 154 |
| :docs | 5 | 787 | 785 | 785 | -2 |
| :judge | 8 | 977 | 1000 | 1000 | 23 |
| :onboarding | 10 | 1458 | 1530 | 1530 | 72 |
| :sim | 6 | 1340 | 1405 | 1405 | 65 |
