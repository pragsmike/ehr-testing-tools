...
| fact | count |
|---|---|
| `*_test.clj` namespaces under any brick's own `test/` | 202 |
| docs-tooling gate namespaces | 47 |
...
| :onboarding | 10 | 1379 | 1530 | 1530 | 151 |
