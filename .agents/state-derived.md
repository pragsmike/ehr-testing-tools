...
| fact | count |
|---|---|
| `*_test.clj` namespaces under any brick's own `test/` | 197 |
| docs-tooling gate namespaces | 53 |
...
| register | count |
|---|---|
| ADR files (`notes/adr/NNNN-*.md`) | 159 |
| roadmap rows (all sections) | 52 |
| rulings rows | 116 |
| rulings rows superseded | 7 |
| session records | 164 |
| archived prompts | 157 |
...
| :onboarding | 10 | 1400 | 1530 | 1530 | 130 |
