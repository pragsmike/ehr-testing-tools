...
- [`site-profiles/`](site-profiles/) — the site-profiles milestone's own
  ...
  dialect surfaces. (Sibling here since the demos front door,
  2026-08-07; its own emitter-owned provenance is unchanged from the
  D1a rider, 2026-08-02, ADR-0029.)
...
place of a single `messages.txt`.)
