(ns ehrt.conformance.smoke-test
  ...
  `projects/integration/test/ehrt/integration/smoke_test.clj` in the same
  ...
  per-push, while this half needs only `ehrt.conformance.sim-harness`, a
