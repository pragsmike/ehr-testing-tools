(ns ehrt.tools.judge-engine-parity-test
...
(def ^:private nist-bundle-dir
  "components/tools/test-fixtures/v2-nist/COVID19_ELR-v2.3.1")

(def ^:private nist-message-file
  "components/tools/test-fixtures/v2-nist/covidELR/231HL7TestFilewithHHSData.txt")

(def ^:private hapi-message-file
  "components/tools/test-fixtures/v2/adt-a08-update-trailing-empty-fields.hl7")
