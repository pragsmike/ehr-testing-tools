(ns ehrt.tools.corpus.operators
  "The mutation operator catalog (ADR-0004): operators as data, a
  registry like ehrt.tools.canonical (pattern nursery #3), and
  ...
  *judging* (judge.v2 uses it unchanged), only disqualified as the
  ...
  contains only defects ehrt.tools.judge.v2's base-structural
