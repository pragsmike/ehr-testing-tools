<!-- GENERATED by `make cli-doc` from the CLI help spec in bases/ehr-cli/src/ehrt/ehr_cli/help.clj -- do not hand-edit.
...
| [`sim`](#ehr-sim) | Run the sim engine, mounted in-process (ADR-0005, ADR-0012 fulfilled) -- ehrt.sim.interface/run-command directly, no subprocess. |
