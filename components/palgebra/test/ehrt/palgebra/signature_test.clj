(ns ehrt.palgebra.signature-test
  "Exercises ehrt.palgebra.signature's loader and schema shapes against a
...
(def toy-signature-path "components/palgebra/test/ehrt/palgebra/fixtures/toy-signature.edn")
