(ns ehrt.corpus.golden-comparison-test
  "Test-first (ruling 5, SS-1 Step 4): written before ehrt.corpus.
  golden-comparison existed. This is the comparison HARNESS's own
