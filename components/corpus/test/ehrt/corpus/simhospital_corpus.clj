(ns ehrt.corpus.simhospital-corpus
  ...
  (`components/corpus/test-fixtures/v2/simhospital/messages.out`, ADR-0011) and names the
...
(def corpus-path
  "components/corpus/test-fixtures/v2/simhospital/messages.out")
...
;; hand-written fixtures in components/corpus/test-fixtures/v2/ chose the same way, and
