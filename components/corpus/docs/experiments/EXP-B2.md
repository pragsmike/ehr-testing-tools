...
- **HL7 v2 ER7**: 3–5 hand-authored ADT fixture messages committed
  under `components/corpus/test-fixtures/v2/` (MSH/EVN/PID/PV1, v2.4, realistic field
...
- `components/corpus/test-fixtures/v2/*.hl7` — the hand-authored ADT fixtures, committed
