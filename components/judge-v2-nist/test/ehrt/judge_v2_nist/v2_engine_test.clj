(ns ehrt.judge-v2-nist.v2-engine-test
  ...
  Π fixture (test-fixtures/v2-nist/, see that
...
(def ^:private bundle-dir "test-fixtures/v2-nist/COVID19_ELR-v2.3.1")
(def ^:private message-file "test-fixtures/v2-nist/covidELR/231HL7TestFilewithHHSData.txt")
