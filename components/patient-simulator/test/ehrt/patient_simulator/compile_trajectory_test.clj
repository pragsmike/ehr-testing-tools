(ns ehrt.patient-simulator.compile-trajectory-test
  ...
  session test obligations) -- written before ehrt.patient-simulator.compile-
...
;; never re-derived here -- `ehrt.patient-simulator.gmf-interpreter/mark-
