(ns ehrt.patient-simulator.compile-trajectory
  ...
  own `:phase` (`ehrt.patient-simulator.gmf-interpreter/run-module`'s own
...
(defn- encounter->step
  ...
  `ehrt.patient-simulator.gmf/encounter-class->keyword`'s own docstring
...
(defn compile-trajectory
  ...
  ehrt.patient-simulator.gmf-interpreter/run-module's own `:trajectory`) x
