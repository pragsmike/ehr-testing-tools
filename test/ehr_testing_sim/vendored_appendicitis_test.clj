(ns ehr-testing-sim.vendored-appendicitis-test
  ...
  evidence, this file), while ehr-testing-sim.compile-trajectory-test's
...
(def appendicitis-json (slurp (io/resource "modules/appendicitis.json")))
(def sinusitis-json (slurp (io/resource "modules/sinusitis.json")))
