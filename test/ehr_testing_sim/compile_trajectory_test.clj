(ns ehr-testing-sim.compile-trajectory-test
  ...
  session test obligations) -- written before ehr-testing-sim.compile-
  ...
  (:require [clojure.java.io :as io]
            ...
            [ehr-testing-sim.compile-trajectory :as ct]
...
(def fixture-clinic
  (:payload (gmf/load-module "fixture-clinic" (slurp (io/resource "ehr_testing_sim/fixtures/fixture-clinic.json")))))
