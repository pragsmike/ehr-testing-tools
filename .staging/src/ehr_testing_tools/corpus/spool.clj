(ns ehr-testing-tools.corpus.spool
  ...
  ehr-testing-tools.corpus.generator-source), a streaming or
...
(def ^:private format->extension
  ...
  same vocabulary as ehr-testing-tools.cli's own format-file-extension,
...
(defn- item-bytes
  "An item, as returned by ehr-testing-tools.corpus.framing/decode, is
...
(defn spool!
  ...
  - whatever ehr-testing-tools.corpus.framing/decode itself rejects
