(ns ehr-testing-tools.corpus.generator-source
  ...
  params (ehr-testing-tools.corpus.generators), deriving a stable
...
(defn resolve!
  "kind -- a registered generator :kind (ehr-testing-tools.corpus.
