(ns ehr-testing-tools.diff
  ...
  (ehr-testing-tools.check's golden-equivalence assertion), which is
...
(defn path->locator-path
  ...
  form (ehr-testing-tools.locator/fhir-data-path is this function's
