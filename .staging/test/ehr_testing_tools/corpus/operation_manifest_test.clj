(ns ehr-testing-tools.corpus.operation-manifest-test
  "Test-first (ADR-0006; SS-4b Step 3): written before
  ehr-testing-tools.corpus.operation-manifest existed. Schema-level
  coverage only -- write-side wiring (ehr-testing-tools.corpus.sink-write)
  and intake-side recognition (ehr-testing-tools.corpus.intake) each own
