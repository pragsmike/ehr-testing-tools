(ns ehr-testing-tools.corpus.generator-source-test
  "Test-first (ruling 3, SS-2 Step 2): written before ehr-testing-tools.
  ...
  ehr-testing-tools.corpus.generators/resolve-params (unknown kind,
  invalid params)."
