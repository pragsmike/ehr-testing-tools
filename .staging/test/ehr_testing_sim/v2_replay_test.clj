(ns ehr-testing-sim.v2-replay-test
  ...
  gets. `ehr-testing-sim.v2-replay/unsupported-trigger` documents the
  ...
  (:require [clojure.java.io :as io]
            ...
            [ehr-testing-sim.v2-replay :as v2-replay]))
    ...
    (let [{:keys [ground-truth facility providers]}
          (engine/run {:seed seed :patients 5
                       ...
                       :modules [(:payload (gmf/load-module
                                            "sinusitis" (slurp (io/resource "modules/sinusitis.json"))))]
