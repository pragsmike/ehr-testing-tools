(ns ehr-testing-sim.vendored-module-test
  ...
  ehr-testing-sim.gmf/ehr-testing-sim.gmf-interpreter were extended this
  ...
  (testing "no module-id collision, no attribute collision -- the
    ...
    (let [sinusitis (:payload (gmf/load-module "sinusitis" sinusitis-json))
      ...
      (let [listed (gmf/loaded-modules (:payload registry))]
        ...
        (is (empty? (apply clojure.set/intersection (map :attributes listed))))))))
