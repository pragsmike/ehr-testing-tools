...
# ---------------------------------------------------------------------------
# Vendored copy.
# Source repo: ehr-testing-tools
# Source path: palgebra/tools/resource_equations_to_mermaid.py
# Commit: 7ecce38ca2f388759c4cb9a934a8c6f2fee7a5c8
# Vendored: 2026-07-27
# Vendored per ADR-0016.
# ---------------------------------------------------------------------------
