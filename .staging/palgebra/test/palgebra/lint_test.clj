(ns palgebra.lint-test
  "Exercises palgebra.lint's catalytic-resource mechanism against the
  toy signature (palgebra.signature-test's fixtures) and a toy
