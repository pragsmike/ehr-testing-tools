(ns ehr-testing-tools.sim-full-capability-gate-test
  ...
  failed on. Skips cleanly (see sim-harness/absence-message) when
...
(deftest ^:integration sim-v2-full-capability-gate-test
