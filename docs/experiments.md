...
| EXP-A4 ([protocol](experiments/EXP-A4.md)) | Verify Synthea determinism: identical seed + version + config ⇒ identical bytes, including across thread counts; enumerate everything that must be pinned | The reproducibility-manifest schema | 2 — cheap |
