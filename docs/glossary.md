...
they used the same word for two different things (R38, ADR-0010[^adr-0010]).
...
Register: `notes/ADRs.md` ADR-0013[^adr-0013]/ADR-0015[^adr-0015] (tools' pre-merge
...
`AUTHORS-GUIDE.md` §1 and `notes/ADRs.md` ADR-0007[^adr-0007] for this workspace's
...
touch. Renamed from `ehr` (ADR-0009[^adr-0009]); `ehr` stays reserved for future
payload-EHR tooling.
...
[`docs/dev/notation.md`](dev/notation.md), `notes/ADRs.md` ADR-0008[^adr-0008]
...
**Pack.** Retired mechanism (`notes/ADRs.md` ADR-0006[^adr-0006]-era, tools'
...
(`notes/ADRs.md` ADR-0005[^adr-0005]): tools used to consume sim by running its
...
this workspace (`notes/ADRs.md` ADR-0001[^adr-0001]). Teaches the testing method;
...
[^adr-0006]: Design record [ADR-0006](../notes/ADRs.md).
