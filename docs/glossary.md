...
Register: `notes/ADRs.md` ADR-0013/ADR-0015 (tools' pre-merge
...
**Pack.** Retired mechanism (`notes/ADRs.md` ADR-0006-era, tools'
...
(`notes/ADRs.md` ADR-0005): tools used to consume sim by running its
...
this workspace (`notes/ADRs.md` ADR-0001). Teaches the testing method;
