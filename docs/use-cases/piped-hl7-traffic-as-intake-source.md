...
**You bring:** A byte stream framed as one of the SS-3 framing kinds (er7-multi here; ndjson/mllp/bundle-entries work the same way) -- this example pipes an excerpt of the vendored SimHospital corpus (test-fixtures/v2/simhospital/messages.out, ADR-0011[^adr-0011]), but any MSH-multi-message file or a real nc pipe works identically.
