(ns ehr-testing-tools.check.schemas
  ...
  ehr-testing-tools.canonical and ehr-testing-tools.corpus.operators
  ...
  this catalog has exactly one consumer (ehr-testing-tools.check) so
