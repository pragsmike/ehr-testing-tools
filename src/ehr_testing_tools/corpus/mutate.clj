(ns ehr-testing-tools.corpus.mutate
  ...
  takes a base datum, an operator entry (ehr-testing-tools.corpus.
  ...
  disqualifying it. v2 operates on ehr-testing-tools.corpus.er7's
...
(defn content-hash
  ...
  serialization. v2 uses ehr-testing-tools.corpus.er7/content-hash
...
(defn- mutate-v2
  ...
  ehr-testing-tools.corpus.er7/parse is called internally, so the
